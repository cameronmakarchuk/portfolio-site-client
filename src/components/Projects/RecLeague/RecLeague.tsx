...
export default function ProjectRecLeague(): JSX.Element {
	...
	const { title, position, responsibilities, date, mockups, techStack, problem } = recleagueDetails;
	...
	return (
		<section className='project'>
			...
			<a className='project__link' href='https://github.com/cameronmakarchuk/recleague-client'>
